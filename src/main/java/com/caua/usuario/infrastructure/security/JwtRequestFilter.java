package com.caua.usuario.infrastructure.security;

import com.caua.usuario.infrastructure.exceptions.dto.ErrorResponseDTO;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            response.getWriter().write(buildError(HttpStatus.UNAUTHORIZED.value(), "Token expirado", request.getRequestURI(),
                    e.getMessage()));
        }
    }
